      ...
      fields: [
        ...
        },
        {
          ...
          options: [
            ...
            { label: "Error", value: "06" },
            { label: "Invalid transaction", value: "12" },
            { label: "Invalid amount", value: "13" },
            { label: "No such card", value: "14" },
            { label: "No such issuer", value: "15" },
            { label: "Customer cancellation", value: "17" },
            { label: "Format error", value: "30" },
            { label: "Pick-up, card acceptor contact acquirer", value: "35" },
            { label: "Pick up, card restricted", value: "36" },
            { label: "Pick up, call acquirer security", value: "37" },
            { label: "Pick up, Allowable PIN tries exceeded", value: "38" },
            { label: "No credit account", value: "39" },
            { label: "Requested function not supported", value: "40" },
            { label: "Pick up, lost card", value: "41" },
            { label: "No universal account", value: "42" },
            { label: "Pick up, stolen card", value: "43" },
            { label: "Expired card / target", value: "54" },
            { label: "Incorrect PIN", value: "55" },
            { label: "No card record", value: "56" },
            { label: "Transaction not permitted to cardholder", value: "57" },
            { label: "Transaction not permitted to terminal", value: "58" },
            { label: "Suspected fraud", value: "59" },
            { label: "No reason to decline", value: "85" },
            { label: "Cryptographic failure", value: "88" },
            { label: "Authentication failure", value: "89" },
            { label: "Issuer or switch is inoperative", value: "91" },
            { label: "Reconcile error / Auth Not found", value: "95" },
            { label: "System Malfunction", value: "96" }
          ],
        },
        {
          type: "text",
